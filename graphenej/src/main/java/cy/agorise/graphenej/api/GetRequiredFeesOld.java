 ...
 */
public class GetRequiredFeesOld extends BaseGrapheneHandler {
     ...
     */
    public GetRequiredFeesOld(List<BaseOperation> operations, Asset asset, boolean oneTime, WitnessResponseListener listener){
        super(listener);
     ...
     *                      success/failure of the operation.
     */
    public GetRequiredFeesOld(List<BaseOperation> operations, Asset asset, WitnessResponseListener listener){
