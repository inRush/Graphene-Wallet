 ...
 */
public class GetKeyReferences extends BaseRpcHandler {

    private List<Address> addresses;

    public GetKeyReferences(WebSocketService service, List<Address> addresses) {
        super(service);
...
//    }
    ...
    protected String getApiName() {
        return RPC.CALL_GET_KEY_REFERENCES;
    }
    ...
    protected WitnessResponse onResponse(String result) {
        ...
        Type GetAccountByAddressResponse = new TypeToken<WitnessResponse<List<List<UserAccount>>>>(){}.getType();
        builder.registerTypeAdapter(UserAccount.class, new UserAccount.UserAccountSimpleDeserializer());
        return builder.create().fromJson(result, GetAccountByAddressResponse);
    }
}
