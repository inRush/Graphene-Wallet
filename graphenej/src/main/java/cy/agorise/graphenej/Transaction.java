...
import cy.agorise.graphenej.operations.AccountOperation;
...
public class Transaction implements ByteSerializable, JsonSerializable {
     ...
     */
    private byte[] chainId = Util.hexToBytes(Chains.GXS.CHAIN_ID);
    ...
    public static class TransactionDeserializer implements JsonDeserializer<Transaction> {
        ...
        public Transaction deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            SimpleDateFormat dateFormat = new SimpleDateFormat(Util.TIME_DATE_FORMAT, Locale.ENGLISH);
            dateFormat.setTimeZone(TimeZone.getTimeZone("GMT"));
            ...
            ArrayList<String> singatures = new ArrayList<>();
            for (JsonElement signature : jsonObject.get(KEY_SIGNATURES).getAsJsonArray()) {
                singatures.add(signature.getAsString());
            }
            ...
            try {
                for (JsonElement jsonOperation : jsonObject.get(KEY_OPERATIONS).getAsJsonArray()) {
                    ...
                    if (operationId == OperationType.TRANSFER_OPERATION.ordinal()) {
                        ...
                        operation = context.deserialize(jsonOperation, AccountOperation.class);
                        //TODO: Add operation deserialization support
                ...
                Transaction transaction = new Transaction(blockData, operationList);
                transaction.setSignature(singatures);
                return transaction;
            } catch (Exception e) {
