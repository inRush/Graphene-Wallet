...
import com.gxb.sdk.wallet.authority;
import com.gxb.sdk.wallet.common.UnsignedShort;
...
//        ref_block_num = new UnsignedShort((short) bitutil.endian_reverse_u32(reference_block.hash[0]));
        ref_block_num  = new UnsignedShort((short)(reference_block.hash[0] & 0xffff));
    ...
    public required_authorities get_required_authorities() {
        ...
        for (com.gxb.sdk.wallet.graphene.chain.operations.operation_type operationType : operations) {
            com.gxb.sdk.wallet.graphene.chain.operations.base_operation baseOperation =
                    (com.gxb.sdk.wallet.graphene.chain.operations.base_operation) operationType.operationContent;
    ...
    public sha256_object sig_digest(sha256_object chain_id) {
        ...
        for (com.gxb.sdk.wallet.graphene.chain.operations.operation_type operationType : operations) {
            ...
            com.gxb.sdk.wallet.graphene.chain.operations.base_operation baseOperation = (com.gxb.sdk.wallet.graphene.chain.operations.base_operation) operationType.operationContent;
