...
import com.gxb.sdk.crypto.digest.RIPEMD160Digest;
...
public class HashUtils {
   ...
   /**
    * Calculate the RipeMd160 value of an array of bytes. This is
   ...
   public static byte[] addressHash(byte[] pubkeyBytes) {
      ...
      ripeMD160.update(pubkeyBytes, 0, pubkeyBytes.length);
      // This also resets the hash function for
